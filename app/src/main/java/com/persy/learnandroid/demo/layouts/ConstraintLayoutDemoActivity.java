...
import com.persy.learnandroid.databinding.ActivityLayoutConstraintDemoBinding;

public class ConstraintLayoutDemoActivity extends AppCompatActivity {

    private ActivityLayoutConstraintDemoBinding binding;
    ...
    private void setupToolBar() {
        ...
        if (getSupportActionBar() != null) {
            ...
            getSupportActionBar().setTitle(topicTitle != null ? topicTitle : "ConstraintLayout Demo");
