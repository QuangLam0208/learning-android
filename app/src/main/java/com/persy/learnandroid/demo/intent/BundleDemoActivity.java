...
import com.persy.learnandroid.databinding.ActivityIntentSendBundleBinding;

public class BundleDemoActivity extends AppCompatActivity {

    private ActivityIntentSendBundleBinding binding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        binding = DataBindingUtil.setContentView(this, R.layout.activity_intent_send_bundle);
    ...
    public void onSendClick() {
        ...
        Intent intent = new Intent(BundleDemoActivity.this, ReceiveDataActivity.class);
        intent.putExtra("DATA_TYPE", "BUNDLE");
